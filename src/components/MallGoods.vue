      ...
      <el-card :body-style="{padding: 0}">
        ...
        <div class="good-price pr">
          <div class="ds pa">
            ...
            <a href="javascript:;">
              <el-button type="primary" size="medium" @click="addCart(goods.productedId,goods.salePrice,goods.productName,goods.productImageBig)">加入购物车</el-button>
            </a>
          </div>
          <p>   
